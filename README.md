...
In this homework assignment we use node.js to create a readme generator. I found template examples online and looked them over. This readme generator runs in your terminal within vs code, simply enter the information it prompts you for and a readme file will be generated in your project folder. Run node index.js to start the generator. The file will be made as "createdReadMe.md" because I have to have a read me for the homework assignment, change it to readme.md.
